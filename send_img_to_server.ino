...
//======================================== 
const char* ssid = "AmalKr";
const char* password = "*********";
//======================================== 


String serverName = "***.***.***.***"; //local ip add 
...
void setup() {
  ...
  Serial.println();
  Serial.print("Press the button to capture and send a photo to the server.");
}
//________________________________________________________________________________ 

//________________________________________________________________________________ VOID LOOP()
void loop() {
  // Check if the button is pressed (LOW means pressed due to pull-up configuration)
  if (digitalRead(BUTTON_PIN) == LOW) {
    delay(50); // Debounce delay
    if (digitalRead(BUTTON_PIN) == LOW) {
      sendPhotoToServer();  // Capture photo and send to server when button is pressed
    }
  }
  delay(100);  // Small delay for button checking loop
}
//________________________________________________________________________________ 
